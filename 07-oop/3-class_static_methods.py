...
print(member_one.full_name()) #we can jst call our class method normaly
print(Member.full_name(member_one)) #what pyhton do behind the scens

Member.say_hello() #we can jst call our static method normaly